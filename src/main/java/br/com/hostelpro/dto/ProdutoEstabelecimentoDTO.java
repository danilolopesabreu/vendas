...
public class ProdutoEstabelecimentoDTO {
	...
	private Integer quantidadeCarrinho = 0;
	...
	public Integer getProdutoBaseId() {
		return produtoBaseId;
	}

	public void setProdutoBaseId(Integer produtoBaseId) {
		this.produtoBaseId = produtoBaseId;
	}
